...
TEST(test_utils, test_vandermonde_1d) {
    unsigned n = 4;
    xt::xarray<double> r = {0.1, 0.3, 0.7, 0.9};
    auto output = oiseau::utils::vandermonde_1d(n, r);
...
TEST(test_utils, test_grad_vandermonde_1d) {
    unsigned n = 4;
    xt::xarray<double> r = {0.1, 0.3, 0.7, 0.9};
    auto output = oiseau::utils::grad_vandermonde_1d(n, r);
